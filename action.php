...
if (isset($_POST['booking'])) {
    ...
    if (mysqli_num_rows($run)>0) {
      ...
      if ($run) {
          ...
          $sql="INSERT INTO `ticket` (`tid`, `bus_id`, `uid`, `seat_no`, `no_seat`, `ticket_status`, `jdate`, `booking_date`, `pname`) VALUES (NULL, '$bid', '$uid', '$tseatno', '$no_p', 'i', '$jid', '$date', '$name')";
          $run=mysqli_query($con,$sql);
          if ($run) {
             echo "Your Ticket is booked .....Thank you";
